...
$cond="Bank='".$_Bank."'  and Disposed='N' order by Branch";
...
<Thead>
<tr><td colspan=10 align=Center bgcolor=#ccffcc><font face=arial size=3>Case Under
<b><?php echo $_Bank;?> with Zero Collection
</font></td></tr>
<tr>
...
{
if($objBp->BalanecAmount($row[$ii]['Case_id'])==$row[$ii]['Amount'])
{
$i++;
?>
<tr>
