...
if (i==1)
{
myform.action="CommonNotice.php?tag=2&ptype=0&mtype="+i;
myform.submit();
}

if(i==101 || i==102 || i==2) //postback on textbox
{    
myform.action="CommonNotice.php?tag=2&ptype=1&mtype="+i;    
myform.submit();
}
...
{
myform.action="Insert_CommonNotice.php";
myform.submit();
}
else
alert('Invalid Data');
...
{
?>
<a href="GenerateCommonNotice.php?id=<?php echo $_SESSION['oldid'];?>"   target=_blank>Generate Show Cause Notice for Case ID-<?php echo $_SESSION['oldid'];?></a>
<?PHP } 
?>   
