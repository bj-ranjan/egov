<html>
<head>
<title>Entry Form for circle</title>
</head>
...
myform.Cir_code.value=mvalue;

var a=myform.Cir_code.value ;//Primary Key
if ( isNaN(a)==false && a!="")
{
myform.action="Form_circle.php?tag=2&ptype=0";
myform.submit();
}
}
...
function redirect(i)
{
myform.action="Form_circle.php?tag=2&ptype=1&mtype="+i;
myform.submit();
}
...
$mvalue[3]=0;
$mvalue[0]=$objCircle->MaxCir_code();
}
else
{
$mvalue[0]="0";//Cir_code
...
$mvalue[0]=$objCircle->MaxCir_code();//Cir_code
$mvalue[1]="";//Circle
$mvalue[2]="";//Circle_ass
...
$mvalue[1]=$_POST['Circle'];
else
$mvalue[1]=0;

if (isset($_POST['Circle_ass']))
$mvalue[2]=$_POST['Circle_ass'];
else
$mvalue[2]=0;
...
if (isset($_POST['Cir_code']))
$pkarray[0]=$_POST['Cir_code'];
else
$pkarray[0]=0;
$objCircle->setCir_code($pkarray[0]);
if ($objCircle->EditRecord()) //i.e Data Available
{ 
if ($ptype==0) //Post Back on Edit Button Click
{
$mvalue[0]=$objCircle->getCir_code();
$mvalue[1]=$objCircle->getCircle();
$mvalue[2]=$objCircle->getCircle_ass();
$mvalue[3]=0;//last Select Box for Editing
} //ptype=0
$_SESSION['update']=1;
} 
...
<tr><td colspan=2 align=Center bgcolor=#ccffcc><font face=arial size=3>Entry/Edit Form for Circle<br></font><font face=arial color=red size=2><?php echo  $_SESSION['msg'] ?></font></td></tr>
<?php $i=0; ?>
<tr>
<td align=right bgcolor=#FFFFCC><font color=black size=2 face=arial>Circle Code</font></td><td align=left bgcolor=#FFFFCC>
<input type=hidden size=8 name="Cir_code" id="Cir_code" value="<?php echo $mvalue[$i]; ?>" onfocus="ChangeColor('Cir_code',1)"  onblur="ChangeColor('Cir_code',2)" onchange=direct1()>
<?php echo $mvalue[$i]; ?>
</td>
</tr>
<?php $i++; //Now i=1?>
<tr>
<td align=right bgcolor=#FFFFCC><font color=black size=2 face=arial>Circle Name</font></td><td align=left bgcolor=#FFFFCC>
<input type=text size=30 name="Circle" id="Circle" value="<?php echo $mvalue[$i]; ?>" style="font-family: Arial;background-color:white;color:black; font-size: 12px" maxlength=30 onfocus="ChangeColor('Circle',1)"  onblur="ChangeColor('Circle',2)">
</td>
</tr>
<?php $i++; //Now i=2?>
<tr>
<td align=right bgcolor=#FFFFCC><font color=black size=2 face=arial>Circle Name(Ass)</font></td><td align=left bgcolor=#FFFFCC>
<input type=text size=50 name="Circle_ass" id="Circle_ass" value="<?php echo $mvalue[$i]; ?>" style="font-family: Arial;background-color:white;color:black; font-size: 12px" maxlength=50 onfocus="ChangeColor('Circle_ass',1)"  onblur="ChangeColor('Circle_ass',2)">
</td>
</tr>
<?php $i++; //Now i=3?>
...
<input type=button value=Menu  name=back1 onclick=home(<?php echo $prev;?>) onfocus="ChangeFocus('Cir_code')" style="font-family:arial; font-size: 14px ; background-color:white;color:blue;width:100px">
</td></tr>
<tr><td align=right>
<?php 
...
if($mtype==1)//Postback from Cir_code
echo $objUtility->focus("Circle");

if($mtype==2)//Postback from Circle
echo $objUtility->focus("Circle_ass");

if($mtype==3)//Postback from Circle_ass
echo $objUtility->focus("Cir_code");
