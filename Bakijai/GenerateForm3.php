...
{
$bankbranch=$objBakijai_main->getBank()."(".$objBakijai_main->getBranch().")";
...
FORM NO.3<BR>
NOTICE TO CERTIFICATE DEBTOR<BR>
(SEE SECTION-7)
<BR>
    
            </font></td></tr>
<tr>
<td align=left valign="top" width="100%" colspan=2><font face=arial size=3>
Case No-<b><?php echo $bankbranch."/".$caseno;?></b>
</td>
</tr>
<tr>
<td align=right valign="top" width="100%" colspan=2><font face=arial size=3>
Trial Date Fixed-<b><?php echo $nextdate;?></b>
</td>
</tr>
...
<b><?php echo $amt;?></b> &nbsp;due from you on account of<b>
<?php  echo $bankbranch;?></b>, has this day been filed in my office, under
 section 46 of the Bengal Public Demand Recovery Act, 1913. 
...
If you
  deny your liability to pay the said sum of Rs.<b><?php echo $amt;?></b>
   you may within thirty days, from the service of this notice,
    ...
    or, in part.<br> If within the said thirty days, you failed to file
 ...
 If you in the meantime conceal, remove or dispose
       of any part of your movable property, the Certificate will be executed
      immediately.
      <br>
   &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;    
 A copy of the Certificate above mentioned is here to annexed. 
<br>
You may
...
<td width=50% align="center">
    <br><br><font face="arial" size="3"><b>
        Certificate Officer<br>Nalbari</b></td>
</tr>
</table>
