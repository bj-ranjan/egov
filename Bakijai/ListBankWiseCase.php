...
{
if ($_SESSION['day']==$row[$ind]['Bank_name'])
{
?>
...
as on Date(Morning)
<input type="text" size="12" name="mdate" value="<?php echo $_SESSION['mdate']?>" maxlength="10">
...
$str=" bank='".$_SESSION['day']."' order by disposed,court_case,case_id";
...
<tr><td width="100%" colspan="8" align="center"><font face="arial" size="2" color="red">Payment Status of Cases  under <?php echo $_SESSION['day']?> </td></tr>
...
<td width="10%" bgcolor="#CCFFFF" align="center"><font face="arial" size="2">Case No</td> 
...
<td width="8%" bgcolor="#CCFFFF" align="center"><font face="arial" size="2">Balance</td>    
