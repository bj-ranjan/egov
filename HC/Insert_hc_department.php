...
$b_Name=$_POST['Name'];
$mvalue[1]=$b_Name;
if ($objUtility->validate($b_Name,100)==true)
{
...
if ($myTag==0)
{
$objHc_department->setCode($a_Code);
$objHc_department->setName($b_Name);
if ($_SESSION['update']==0)
{
$result=$objHc_department->SaveRecord();
$mmode="Data Entered Successfully";
$sql=$objHc_department->returnSql;
$col=1;
}
else
{
$result=$objHc_department->UpdateRecord();
$col=$objHc_department->colUpdated;
if ($col>0)
...
if ($col>0)
$objUtility->saveSqlLog("Hc_department",$sql);
$_SESSION['update']=0;
$_SESSION['mvalue']=$mvalue;
} //$result
} 
...
header( 'Location: Form_hc_department.php?tag=1');
?>
<a href=Form_hc_department.php?tag=1>Back</a>
</body>
</html>
