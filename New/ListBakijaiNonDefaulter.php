...
$objTab->genDataGridOnValueList("List of Non Defaulter", $headlist = array("Case ID", "Bank", "Branch", "Name of Defaulter", "Amount of Loan","Amount Received", "Last Paid Date"), $align = array(2, 1, 1, 1, 3, 3,2), $List, 100, count($List));
