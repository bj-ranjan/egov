...
$sign=$objPetition_master->getSignedBy("BK");
...
District of $dist is not a Bakijai defaulter as per office record. 
<br>
<br>
</div>
</td>
...
<tr><td colspan="2" align="center" width="100%"><br>
...
<tr>
<td  align="left" width="100%">Processed by $username on URL $ip</td>
</tr>
</table>
EOD;
...
if($mpdf==true)
{
$pdf->writeHTML("<br><br><br><br><br><br><br><br><br>", true, false, false, false, '');
//ob_end_clean();
...
EOD;
//$pdf->writeHTML($gap, true, false, false, false, '');
