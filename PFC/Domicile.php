...
$sign=$objPetition_master->getSignedBy("DM");
...
if($objPetition_master->getPet_type()!="DM")
...
$ip="http://".$ip."/egov/pfc/prc.php?yr=".$Pet_yr."&pno=".$Pet_no."  Process Date:".$prdate;
...
<tr>
<td width="10%">&nbsp;</td>
<td align="left" width="$cwidth[1]">No.<b>NA/01/$Pet_yr/$Pet_no</b></td>
...
Sri/Smti <b>$name </b> is a resident of following address by domicile.
<br>
Father/Husband's Name:-<b> $fname</b>
<br>
Mother's Name:-<b> $mname</b>
<br>
Name of Circle:-<b> $circle</b>
<br>
Name of Mouza:-<b> $mouza</b>
<br>
Name of Police Station:-<b>$ps</b>
<br>Name of Village:-<b>$village</b>       
<br>
Name of District:-<b> $dist,Assam(India)</b>     
<br>
This certificate is applicable only for appointment of paramilitary forces as well as enrolment in the army and in the Central Govt.Departments and undertakings.
</div>
</td>
</tr>
<tr>
