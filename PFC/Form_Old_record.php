...
if(NumericValid('No1',1,'Positive')==true && NumericValid('No2',1,'Positive')==true)    
{
window.open("./obcst/viewOldStatement.php?"+data,'_blank');
}
else
...
if ( NumericValid('Id',1,'NonNegative')==true   && SelectBoxIndex('Cert_type')>0  && StringValid('Cert_no',1,1) && DateValid('Issue_date',1) && StringValid('Name_of_certholder',1,1) && StringValid('Fathers_name',0,1) && StringValid('Village',1,1) &&  1==1)
{
...
else if (SelectBoxIndex('Cert_type')==0)//0-Simple Validation
{
...
//Start of FormDesign
//Header Line
$objOld_record->TextHeader("BACKLOG ENTRY OF OLD CERTIFICATE RECORDS",95,2,$HeadColor,$fcol,3);
...
echo "<tr>";
$objOld_record->bcol=$BodyColor;//Set Back Color Table Cell
$objOld_record->TdText(3, 2,"Certificate Type", 0, 0, 0);
$objOld_record->bcol="white";//Set Back Color for Html Box
$function=" onchange=direct1()";
//TdInputBox(1,$bcol,$id,$val,$size,$maxlength,$function,$mandatory)
...
echo "<td>";
$objOld_record->genSelectBoxByValueArray("Cert_type", $ValueList, $mvalue[1], 140, $bcol, $fcol, $font, "");
echo "</td>";
...
echo "<tr>";
$objOld_record->bcol=$BodyColor;//Set Back Color Table Cell
$objOld_record->TdText(3, 2,"Certificate No", 0, 0, 0);
$objOld_record->bcol="white";//Set Back Color for Html Box
$function=" onchange=direct1()";
//TdInputBox(1,$bcol,$id,$val,$size,$maxlength,$function,$mandatory)
$objOld_record->TdInputBox(1,$bcol,"Cert_no",$mvalue[2],50,50,$function,1);
...
echo "<tr>";
$objOld_record->bcol=$BodyColor;//Set Back Color Table Cell
$objOld_record->TdText(3, 2,"Issue Date", 0, 0, 0);
$objOld_record->bcol="white";//Set Back Color for Html Box
$function=" onchange=direct1()";
//TdInputBox(1,$bcol,$id,$val,$size,$maxlength,$function,$mandatory)
$objOld_record->TdInputBoxWithDatePicker(1,$bcol,"Issue_date",$mvalue[3],10,10,$function,2);
echo "</tr>";
//ROW-5
echo "<tr>";
$objOld_record->bcol=$BodyColor;//Set Back Color Table Cell
$objOld_record->TdText(3, 2,"Name of Certificate Holder", 0, 0, 0);
$objOld_record->bcol="white";//Set Back Color for Html Box
$function=" onchange=direct1()";
//TdInputBox(1,$bcol,$id,$val,$size,$maxlength,$function,$mandatory)
...
echo "<tr>";
$objOld_record->bcol=$BodyColor;//Set Back Color Table Cell
$objOld_record->TdText(3, 2,"Father's Name", 0, 0, 0);
$objOld_record->bcol="white";//Set Back Color for Html Box
$function=" onchange=direct1()";
//TdInputBox(1,$bcol,$id,$val,$size,$maxlength,$function,$mandatory)
...
$function=" onchange=direct1()";
//TdInputBox(1,$bcol,$id,$val,$size,$maxlength,$function,$mandatory)
$objOld_record->TdInputBox(1,$bcol,"Village",$mvalue[6],80,80,$function,1);
...
//$objOld_record->genSelectBox($id, $query, $val, $pix, $bcol, $fcol, $font, $function);
$objOld_record->genSelectBox("Editme", $query,$mvalue[7],"300", $bcol, $fcol, $font, $function);
echo "</td></tr><tr>";
...
echo "</td></tr>";
echo "</tbody></table>";
echo "<table border=0 align=center bgcolor=yellow>";
echo "<tr><td align=left>Cert Type</td><td>";
$fun=" ";
$objOld_record->DefaultOptRequired=0;
$objOld_record->genSelectBoxByValueArray("rType", $ValueList, '', 140, $bcol, $fcol, $font, "");
//echo "<td align=right>Year</td>";
//$objOld_record->TdInputBox(1, $bcol, "rYear", date('Y'), 4, 4, $fun, 0);
echo "<td align=right>Start No</td>";
$objOld_record->TdInputBox(1, $bcol, "No1", "", 6, 6, $fun, 0);
echo "<td align=right>Last No</td>";
$objOld_record->TdInputBox(1, $bcol, "No2", "", 6, 6, $fun, 0);
echo "<td align=center>";
$objOld_record->genButton("a", "View Statement", 140, $bcol, $fcol, 10, " onclick=viewst()");
echo "</td>";
echo "</tr>";
echo "</table>";
echo "</form>";
...
$sql="Select Id,Cert_type,Cert_no,Issue_date,Name_of_certholder,Village from old_record order by Id desc limit 20";
