...
$sign=$objPetition_master->getSignedBy("NC");
...
$ip="http://".$ip."/egov/pfc/NCL.php?yr=".$Pet_yr."&pno=".$Pet_no."  Process Date:".$prdate;
...
<img src="../Image/Ashoka1.gif" width="75" height="90">
</td>
</tr>
<tr>
<td width="10%">&nbsp;</td>
...
<tr>
<td width="10%">&nbsp;</td>
<td align="left" width="$cwidth[1]">No.<b>NA.03/$Pet_yr/$Pet_no</b></td>
...
Sri/Smti <b>$name </b> $relation<b> $fname</b> and <b>$mname</b> 
of village <b>$village</b> of District
$dist in the State of Assam belongs to    
<b> $subcaste</b> community which is recognised as 
a backward class under the Govt. of India,Ministry of Welfare
...
dated 13th September,1993.
<br><br>
Sri/Smti <b>$name </b> and his/her family ordinarily resides
in the $dist District in the State of Assam.
<br><br>This is also to certify that he/she doesnot belong to 
the persons/sections(Creamy layer) mentioned in column 3
of the Schedule to the Govt. of India, Department of
Personnel and Training O.M. No. 36012/22/93 Estt(SCT)
dated 08/09/1993.
</div>
</td>
</tr>
...
<br><br>
(This Certificate is valid for one year from the date of
