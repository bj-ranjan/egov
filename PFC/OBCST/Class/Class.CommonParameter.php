...
//Handle remaining Row
    ...
    public function returnGeneralCheckBox($id, $val, $function) {
     ...
     public function Return_JSON_Object_For_SelectBox($List, $SelecVal, $Default,$ExtraHeader=array()) { //This Return Value as Object is to be Parsed using JSON.parse()
        ...
        if ($Default > 0 || $Default == true) {
            echo "{" . chr(34) . "Opt" . chr(34) . ":" . chr(34) . $this->DefaultOpt . chr(34);
            echo "," . chr(34) . "Detail" . chr(34) . ":" . chr(34) . $this->DefaultOptDetail . chr(34) . "}";
        }

        for ($i = 0; $i < count($List); $i++) {
            if ($a > 0)
                echo ",";
            echo "{" . chr(34) . "Opt" . chr(34) . ":" . chr(34) . $List[$i][0] . chr(34);
            echo "," . chr(34) . "Detail" . chr(34) . ":" . chr(34) . $List[$i][1] . chr(34) . "}";
            $a++;
        }//for loop
        echo "]}"; //  End Code 
