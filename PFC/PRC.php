...
$sign=$objPetition_master->getSignedBy("PR");
...
if($objPetition_master->getPet_type()!="PR")
...
Sri/Smti <b>$name </b> $relation<b> $fname</b> and <b>$mname</b> is a
permanent resident of Village/Town  <b>$village</b>
Mauza<b> $mouza</b> under Police Station <b>$ps</b>    
of District $dist,Assam(India).
<br>
<br>
This Permanent Residence Certificate is applicable only for
the purpose of Higher Education and shall not be valid for other
purposes.
</div>
</td>
</tr>
