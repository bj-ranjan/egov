...
myform.Period.disabled=false;
//myform.Purpose.visible=false;
...
myform.Period.disabled=true;
//myform.Purpose.visible=true;
...
var b=myform.Purpose.selectedIndex;
var c=myform.Period.value ;
var c_length=parseInt(c.length);
if ( notNull(a) && validateString(a) && a_length<200 && b>0 && validateString(c) && c_length==4 && isNumber(c))
{
myform.action="ProcessPRC.php?tag=2";
myform.submit();    
}
else
...
$mvalue[8]=$objPetition_master->getPurpose();
$mvalue[9]=$objPetition_master->getPeriod();
...
$ctype=strtoupper($objPt->getAbvr());
}
else
$serviceId=0;
...
if ($objPetition_master->getAst()=="Y" || $objPetition_master->getStatus()!="Pending" || ($objPetition_master->getPet_type()!="PR" && $objPetition_master->getPet_type()!="DM"))
...
{
if($objPetition_master->getPet_type()!="PR" && $objPetition_master->getPet_type()!="DM")
header( 'Location: PetitionList.php?tag=0');
...
$Rejected_reason="NULL";
if (isset($_POST['Purpose'])) //If HTML Field is Availbale
{
$Purpose=$_POST['Purpose'];
if ($objUtility->validate($Purpose,50)==true)
{
//Unicode Shouldnot Exist
if ($objUtility->isUnicodeCharExist($Purpose)==true)
{
$myTag++;
$Err=$Err." Expect NonUnicode in Purpose";
}
...
$Purpose="NULL";
if (isset($_POST['Period'])) //If HTML Field is Availbale
{
$Period=$_POST['Period'];
if ($objUtility->validate($Period,4)==true)
{
//Unicode Shouldnot Exist
if ($objUtility->isUnicodeCharExist($Period)==true)
{
$myTag++;
$Err=$Err." Expect NonUnicode in Period";
}
...
$objPetition_master->setPeriod($Period);
$objPetition_master->setPurpose($Purpose);
...
<tr><td colspan=2 align=Center bgcolor=#ccffcc><font face=arial size=3>Successfully Processed <br>Petition No <b><?php echo $pno;?></b> for <?php echo $ctype;?> Certificate<b></font></td></tr>
<tr><td align=Center>
<?php 
...
<form name=myform action=""  method=POST >
<tr><td colspan=4 align=Center bgcolor=#ccffcc><font face=arial size=3>PROCESS <?php echo $ctype;?><br><b><font color="#CC66FF"><?php echo  $_SESSION['msg'] ?></b></font>
...
<tr>
<td align=right bgcolor=#FFFFCC><font color=black size=2 face=arial>Purpose of PRC</font></td><td align=left bgcolor=#FFFFCC>
<select name="Purpose" id="Purpose" style="font-family: Arial;background-color:white;color:black; font-size: 14px;font-weight:bold;width:160px">
    <option value=""><-Select->
<option value="Education">Education
<option value="Service">Service
<option value="Other">Other Purpose  
</select>    
</td>
<?php $i++; //Now i=9?>
<td align=right bgcolor=#FFFFCC><font color=black size=2 face=arial>Living Since</font></td><td align=left bgcolor=#FFFFCC>
<input type=text maxlength="4" size=6 name="Period" id="Period" value="<?php echo $mvalue[9]; ?>" style="font-family: Arial;background-color:white;color:black; font-size: 14px" maxlength=10 onfocus="ChangeColor('Period',1)"  onblur="ChangeColor('Period',2)" disabled>
<font color=black size=1 face=arial>(Enter 4 Digit Year)
</td>
</tr>
<?php $i++; //Now i=6?>
<tr>
