...
send_message(1, "Connecting Database....", 0);
...
$mfile="Backup".date('Ymd').".sql";
$fname="../Database/".$mfile;
...
{
$mdtype=$myDataType[$k];
if (preg_match('/CHAR/', $mdtype) == true || preg_match('/TEXT/', $mdtype) == true) //Remove Escape Character
{
...
$maindatastr=$maindatastr.";\n"; 
$msg=$eventmsg." Row-".$j2."/".$j1;
send_message($j2, $msg, round(($j2 / $j1) * 100));
...
$a.="<br><a href=" . $orgfile . ">Download File</a>";
