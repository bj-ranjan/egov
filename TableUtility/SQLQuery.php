...
if(i==2)
MyAjaxFunction("POST","genXls.php",data,'ResultFrame',"HTML");        
}
else
alert('Null String') ;   
}
...
<tr><td>
<input type=button value="Execute Query" name=Save1 id="Save1" onclick="validate(1)" style="font-family:Arial;background-color:orange;color:blue;font-weight:bold; font-size: 14px" <?php echo $dis;?>>
...
<input type=button value="Export Result to Excell" name=Save2 id="Save2" onclick="validate(2)" style="font-family:Arial;background-color:#66CCFF;color:blue;font-weight:bold; font-size: 14px;width:200px" <?php echo $dis;?>>
 </td></tr>
 </table>
 </td></tr>
 </table>
