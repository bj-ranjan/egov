...
$objBank_master=new Bank_master();
$cond="1=1";
$totrec=$objBank_master->rowCount($cond);
$objUtility=new Utility();
$cspan=3;
$title=<<<EOD
...
<td align="center" width="$cwidth[1]">Bank_name</td>
<td align="center" width="$cwidth[2]">Btype</td>
</tr>
<tr>
...
$slno++;
$rowcount++;
$colvalue[0]=$row[$ii]['Bank_name'];
$colvalue[1]=$row[$ii]['Btype'];
$tbldata=<<<EOD
<tr>
<td align="center" width="$cwidth[0]">$slno</td>
...
if (is_numeric($row[$ii]['Bank_name']))
$tot1=$tot1+$row[$ii]['Bank_name'];
if (is_numeric($row[$ii]['Btype']))
$tot2=$tot2+$row[$ii]['Btype'];
} //for loop
$cspan=1;
$tblfoot=<<<EOD
<table cellpadding="2" cellspacing="0" bordercolor="#000000" border="1"  style="vertical-align:middle;">
