...
$objBank_deposit=new Bank_deposit();
$cond="1=1";
$totrec=$objBank_deposit->rowCount($cond);
$objUtility=new Utility();
$cspan=8;
$title=<<<EOD
...
<td align="center" width="$cwidth[2]">Installment</td>
<td align="center" width="$cwidth[3]">Amount</td>
<td align="center" width="$cwidth[4]">Deposit_date</td>
<td align="center" width="$cwidth[5]">Collection_book_no</td>
<td align="center" width="$cwidth[6]">Collection_rcpt_no</td>
<td align="center" width="$cwidth[7]">Bank_rcpt_no</td>
</tr>
<tr>
...
$lastpage="";
$i=1;
$objBank_deposit->setCondString($cond);
...
$colvalue[1]=$row[$ii]['Installment'];
$colvalue[2]=$row[$ii]['Amount'];
$colvalue[3]=$objUtility->to_date($row[$ii]['Deposit_date']);
$colvalue[4]=$row[$ii]['Collection_book_no'];
$colvalue[5]=$row[$ii]['Collection_rcpt_no'];
$colvalue[6]=$row[$ii]['Bank_rcpt_no'];
$tbldata=<<<EOD
<tr>
<td align="center" width="$cwidth[0]">$slno</td>
...
if (is_numeric($row[$ii]['Installment']))
$tot2=$tot2+$row[$ii]['Installment'];
if (is_numeric($row[$ii]['Amount']))
$tot3=$tot3+$row[$ii]['Amount'];
if (is_numeric($row[$ii]['Deposit_date']))
$tot4=$tot4+$row[$ii]['Deposit_date'];
if (is_numeric($row[$ii]['Collection_book_no']))
$tot5=$tot5+$row[$ii]['Collection_book_no'];
if (is_numeric($row[$ii]['Collection_rcpt_no']))
$tot6=$tot6+$row[$ii]['Collection_rcpt_no'];
if (is_numeric($row[$ii]['Bank_rcpt_no']))
$tot7=$tot7+$row[$ii]['Bank_rcpt_no'];
} //for loop
$cspan=1;
$tblfoot=<<<EOD
<table cellpadding="2" cellspacing="0" bordercolor="#000000" border="1"  style="vertical-align:middle;">
