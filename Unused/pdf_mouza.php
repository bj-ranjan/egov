...
<td align="center" width="$cwidth[1]">Mouza_code</td>
<td align="center" width="$cwidth[2]">Mouza_name</td>
<td align="center" width="$cwidth[3]">Mouza_name_ass</td>
<td align="center" width="$cwidth[4]">Cir_code</td>
</tr>
<tr>
...
$lastpage="";
$i=1;
$objMouza->setCondString($cond);
$row=$objMouza->getAllRecord();
for($ii=0;$ii<count($row);$ii++)
{
$slno++;
$rowcount++;
$colvalue[0]=$row[$ii]['Mouza_code'];
$colvalue[1]=$row[$ii]['Mouza_name'];
$colvalue[2]=$row[$ii]['Mouza_name_ass'];
...
if (is_numeric($row[$ii]['Mouza_code']))
$tot1=$tot1+$row[$ii]['Mouza_code'];
if (is_numeric($row[$ii]['Mouza_name']))
$tot2=$tot2+$row[$ii]['Mouza_name'];
if (is_numeric($row[$ii]['Mouza_name_ass']))
$tot3=$tot3+$row[$ii]['Mouza_name_ass'];
if (is_numeric($row[$ii]['Cir_code']))
$tot4=$tot4+$row[$ii]['Cir_code'];
} //for loop
$cspan=1;
$tblfoot=<<<EOD
<table cellpadding="2" cellspacing="0" bordercolor="#000000" border="1"  style="vertical-align:middle;">
