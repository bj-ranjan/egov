...
$objPolice_station=new Police_station();
$cond="1=1";
$totrec=$objPolice_station->rowCount($cond);
$objUtility=new Utility();
$cspan=4;
$title=<<<EOD
...
<td align="center" width="$cwidth[1]">Code</td>
<td align="center" width="$cwidth[2]">Name</td>
<td align="center" width="$cwidth[3]">Name_ass</td>
</tr>
<tr>
...
$lastpage="";
$i=1;
$objPolice_station->setCondString($cond);
$row=$objPolice_station->getAllRecord();
for($ii=0;$ii<count($row);$ii++)
{
$slno++;
$rowcount++;
$colvalue[0]=$row[$ii]['Code'];
$colvalue[1]=$row[$ii]['Name'];
$colvalue[2]=$row[$ii]['Name_ass'];
$tbldata=<<<EOD
<tr>
<td align="center" width="$cwidth[0]">$slno</td>
...
if (is_numeric($row[$ii]['Code']))
$tot1=$tot1+$row[$ii]['Code'];
if (is_numeric($row[$ii]['Name']))
$tot2=$tot2+$row[$ii]['Name'];
if (is_numeric($row[$ii]['Name_ass']))
$tot3=$tot3+$row[$ii]['Name_ass'];
} //for loop
$cspan=1;
$tblfoot=<<<EOD
<table cellpadding="2" cellspacing="0" bordercolor="#000000" border="1"  style="vertical-align:middle;">
