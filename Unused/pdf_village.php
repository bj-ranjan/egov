...
$objVillage=new Village();
$cond="1=1";
$totrec=$objVillage->rowCount($cond);
$objUtility=new Utility();
$cspan=5;
$title=<<<EOD
...
<td align="center" width="$cwidth[1]">Vill_code</td>
<td align="center" width="$cwidth[2]">Vill_name</td>
<td align="center" width="$cwidth[3]">Cir_code</td>
<td align="center" width="$cwidth[4]">Vill_name_ass</td>
</tr>
<tr>
...
$tot1=$tot1+$row[$ii]['Vill_code'];
if (is_numeric($row[$ii]['Vill_name']))
$tot2=$tot2+$row[$ii]['Vill_name'];
if (is_numeric($row[$ii]['Cir_code']))
$tot3=$tot3+$row[$ii]['Cir_code'];
if (is_numeric($row[$ii]['Vill_name_ass']))
$tot4=$tot4+$row[$ii]['Vill_name_ass'];
} //for loop
$cspan=1;
$tblfoot=<<<EOD
<table cellpadding="2" cellspacing="0" bordercolor="#000000" border="1"  style="vertical-align:middle;">
