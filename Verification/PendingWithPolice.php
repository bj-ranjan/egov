...
$Title="Report Pending with Police";
$headList=array("ID","Letter No & Date","Department","Candidate Name","Police Station","Sent on","Pending For(Days)");
...
$valueList[$ii][6]=$objUtility->dateDiff(date('Y-m-d'),$row[$ii]['Start_date']);
