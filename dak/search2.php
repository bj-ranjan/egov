...
<TD ALIGN=CENTER VALIGN=BOTTOM><FONT COLOR=pink SIZE=6 FACE="MONOTYPE CORSIVA">Dak(Search result by Received Date)</TD></tr>
</TABLE>
...
$pd=new Pwd();
$_SESSION['searchDT'] = $_POST['searchdt'];
$dtarray=array();
...
$query = mysql_query("SELECT * FROM dak_entry WHERE entry_date='$e_Ltr_dt'  ") or die("could not search");
